module.exports = [
"[project]/packages/web/.next-internal/server/app/api/account/bootstrap/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/web/src/server/accounts/bootstrap.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function bootstrap(settings) {
    if (!settings) {
        return {
            error: 'invalid-login-settings'
        };
    }
    const passEnabled = 'password' in settings;
    const openIdEnabled = 'openId' in settings;
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$db$2f$account$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccountDb"])();
    const countRow = db.first("SELECT count(*) as countOfOwner FROM users WHERE user_name <> '' AND owner = 1");
    const countOfOwner = countRow?.countOfOwner ?? 0;
    if (!openIdEnabled || countOfOwner > 0) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$db$2f$account$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["needsBootstrap"])()) {
            return {
    ...
    if (passEnabled) {
        const { error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$accounts$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bootstrapPassword"])(settings.password);
        if (error) return {
            error
        };
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$accounts$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginWithPassword"])(settings.password);
    }
    // openId bootstrap would go here (not ported yet — OpenID is future work)
    return {
        error: 'openid-not-supported'
    };
}
}),
"[project]/packages/web/src/app/api/account/bootstrap/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$accounts$2f$bootstrap$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/web/src/server/accounts/bootstrap.ts [app-route] (ecmascript)");
;
;
;
const BootstrapSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1).optional(),
    openId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].record(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].unknown()).optional()
});
async function POST(request) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$accounts$2f$bootstrap$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bootstrap"])(parsed.data);
    if ('error' in result) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: 'error',
            reason: result.error
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be2eb699._.js.map