module.exports = [
"[project]/packages/web/src/lib/auth-client.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/web/src/app/(auth)/login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/web/src/lib/auth-client.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        setLoading(true);
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"].email({
                email,
                password
            });
            if (result.error) {
...
//# sourceMappingURL=packages_web_src_5798d06f._.js.map