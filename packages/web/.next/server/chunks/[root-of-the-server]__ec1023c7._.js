module.exports = [
"[project]/packages/web/.next-internal/server/app/api/account/validate/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/web/src/app/api/account/validate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GET(request) {
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$db$2f$account$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserInfo"])(session.user_id);
    if (!user) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        data: {
            ...
            prefs: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$web$2f$src$2f$server$2f$db$2f$account$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerPrefs"])()
        }
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec1023c7._.js.map